...
CREATE TABLE `track`.`establishment_try` ( `id` INT NOT NULL AUTO_INCREMENT , `userID` VARCHAR(50) NOT NULL , `location` VARCHAR(500) NOT NULL , `description` VARCHAR(500) NOT NULL , `name` VARCHAR(50) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
