...
CREATE TABLE `track`.`establishment` ( `id` INT NOT NULL AUTO_INCREMENT , `userID` INT NOT NULL , `location` VARCHAR(100) NOT NULL , `description` INT(500) NOT NULL , `name` INT(100) NOT NULL , `No_customer` INT(20) NOT NULL DEFAULT '0' , PRIMARY KEY (`id`)) ENGINE = InnoDB;
