...
CREATE TABLE `track`.`establishment` ( `id` INT NOT NULL AUTO_INCREMENT , `userID` VARCHAR(50) NOT NULL , `location` VARCHAR(500) NOT NULL , `description` INT NOT NULL , `name` INT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
...
CREATE TABLE `track`.`reporr` ( `id` INT NOT NULL AUTO_INCREMENT , `ct_id` INT NOT NULL , `est_id` INT NOT NULL , `date_t` DATE NOT NULL DEFAULT CURRENT_TIMESTAMP , `inside` INT NULL DEFAULT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
